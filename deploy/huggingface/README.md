...
# ProFlo — Full checkout platform

All apps run in one Docker Space behind nginx on port **7860**.

| App | URL |
|-----|-----|
| Customer shop | [/shop](https://adi576-proflo.hf.space/shop) |
| Admin HQ | [/admin](https://adi576-proflo.hf.space/admin) |
| Cashier terminal | [/cashier](https://adi576-proflo.hf.space/cashier) |
...
| `PUBLIC_API_URL` | `https://adi576-proflo.hf.space/checkout-api` |
