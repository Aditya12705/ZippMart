...
- [ ] Change all default admin/manager passwords
- [ ] Set a strong `JWT_SECRET`
- [ ] Set `CASHIER_API_KEY` and matching `NEXT_PUBLIC_CASHIER_API_KEY`
- [ ] Use Supabase pooler URL with encoded password
- [ ] Do not commit `.env` files
- [ ] Restrict CORS to your production domains
- [ ] Plan persistent storage for product images (or accept ephemeral uploads on free tiers)
